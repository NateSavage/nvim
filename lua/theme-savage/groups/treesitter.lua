...
function M.get(c, opts)
  ...
  local ret = {
    ...
    ["@tag.delimiter.tsx"]          = { fg = c.blue },--Util.blend_bg(c.blue, 0.7) },
    ["@tag.tsx"]                    = { fg = c.red },
    ["@tag.javascript"]             = { fg = c.red },
    ["@type"]                       = "Type",
    ["@type.builtin"]               = { fg = c.blue1, }, --Util.blend_bg(c.blue1, 0.8) },
    ...
    ["@variable.parameter.builtin"] = { fg = c.yellow }, --Util.blend_fg(c.yellow, 0.8) }, -- For builtin parameters of a function, e.g. "..." or Smali's p[1-99]
  }
